...
<html lang="en">
  ...
  <body>
    ...
    <p class="text-center font-weight-bold"> View the most recent popular tweets of any username</p>
	<div class ="container">
      ...
      <div class="row justify-content-end">
       ...
       <?php
        ...
        $statuses = $connection->get("statuses/user_timeline", ["count" => 20, "screen_name" => $_GET['username'], "exclude_replies" => true]);
